...
public class telaEstoqueVacina2 extends javax.swing.JFrame{
        ...
        if(txtVacina.getText().equals("") || txtValidade.getText().equals("") ||
           txtQuantidade.getText().equals("") || txtPreco.getText().equals("")){
            ...
            if(estadoSalvar.equals("cadastro")){
                ...
                Vacina vacina = bancoDeDados.getVacinas().get(idx);
                vacina.setTipoVacina(nomeVacina);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {                                          
        ...
        if (idx >= 0) {
            ...
            txtQuantidade.setText(String.valueOf(vacina.getQtd()));
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {                                           
        ...
        if (idx >= 0) {
            ...
            if (confirmacao == JOptionPane.YES_OPTION) {
                ...
                bancoDeDados.getVacinas().remove(idx);
