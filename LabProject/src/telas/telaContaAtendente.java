 ...
 * @author analuisa
 */
public class telaContaAtendente extends javax.swing.JFrame {

    /**
     * Creates new form telaContaAtendente
     */
    public telaContaAtendente() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(telaContaAtendente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new telaContaAtendente().setVisible(true);
            }
        });
    }
